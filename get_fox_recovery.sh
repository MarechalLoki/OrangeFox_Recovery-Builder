...
DEVICE_TREE_URL="https://github.com/TeaqariaWTF/android_device_a12s_samsung_twrp.git"; # device tree url, default is for miatoll
LOCAL_DEVICE_TREE_URL="git@github.com:TeaqariaWTF/android_device_a12s_samsung_twrp.git"; # local device tree url, default is for miatoll
...
test_build_device="a12s"; # default is miatoll
